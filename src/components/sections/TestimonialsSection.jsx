  ...
  const testimonials = [
    {
      ...
      author: "Parent from Gachibowli Community",
      rating: 5,
      highlight: "Convenient & Fun"
    },
    {
      quote: "Super convenient and exciting! The coaches make gymnastics a blast.",
      author: "Happy Mom from Kondapur",
      rating: 5,
      highlight: "Professional Coaches"
    },
    {
      quote: "Amazing to see my daughter's confidence grow with each class. The inflatable mats make it so safe!",
      author: "Parent from Hitech City",
      rating: 5,
      highlight: "Safe & Confidence Building"
    },
    {
      quote: "Best thing we've done for our community! Kids are so excited every week.",
      author: "RWA Member from Madhapur",
      rating: 5,
      ...
      <div className="container-custom">
        ...
        >
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            Hear from happy parents and kids across Hyderabad's gated communities
          </motion.p>
        </motion.div>
        ...
        >
          <div className="bg-white p-6 rounded-xl shadow-md text-center border-t-4 border-ygm-blue">
            ...
            <div className="font-semibold text-ygm-blue mb-2">500+ Happy Kids</div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md text-center border-t-4 border-ygm-orange">
            <div className="text-3xl mb-3">⭐</div>
            <div className="font-semibold text-ygm-orange mb-2">5-Star Reviews</div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md text-center border-t-4 border-ygm-green">
            <div className="text-3xl mb-3">🏆</div>
            <div className="font-semibold text-ygm-green mb-2">Award Winning</div>
        ...
        >
          ...
          <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
            Be the next success story! Invite Young Gymnast 101 for a free workshop 
            and watch your kids discover the joy of gymnastics.
          </p>
